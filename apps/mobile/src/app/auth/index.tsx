...
export default function AuthScreen() {
    const { isAuthenticated, isBusy, sendSupabaseOtp, signInWithFirebase, verifySupabaseOtp } =
        useAuth()
        ...
        <SafeAreaView style={styles.screen}>
            ...
            >
                <View style={styles.header}>
                    ...
                    <Text style={styles.headerTitle}>Repair work, orders, and account access.</Text>
                    <Text style={styles.headerCopy}>
                        Sign in to the Fix iT Rock mobile app with your phone number using Supabase
                        directly or Firebase through the web bridge.
                    </Text>
                </View>
                ...
                <View style={styles.card}>
                    ...
                    {mode === 'supabase' && step === 'otp' ? (
                        <View style={styles.fieldGroup}>
                            ...
                            />
                            <Text style={styles.helpText}>
                                The OTP screen stays in-app for Supabase. Use resend if the code has
                                expired.
                            </Text>
                        </View>
                    ) : null}
                ...
                <View style={styles.darkCard}>
                    ...
                    <Text style={styles.darkCopy}>
                        This build focuses on auth, order activity, transactions, and quick access
                        to the Fix iT Rock workspace. Firebase uses a web handoff and returns a
                        Supabase session to the app.
                    </Text>
                </View>
            </ScrollView>
        </SafeAreaView>
