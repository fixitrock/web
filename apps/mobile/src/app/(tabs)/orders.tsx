    ...
    return (
        ...
        >
            <View className='flex-row gap-3'>
                ...
                <StatCard label='Loaded' value={loading ? '...' : String(orders.length)} />
            </View>
            ...
            {!loading && orders.length === 0 ? (
                <Card className='border border-dashed border-black/10 bg-white/70 shadow-none dark:border-white/10 dark:bg-white/5'>
                    <Card.Body className='p-5'>
                        <Text className='text-foreground/70 text-base leading-6'>
                    ...
                    >
                        <Card.Body className='gap-3 p-5'>
                            <View className='flex-row items-start justify-between gap-4'>
                                ...
                                <Text className='text-foreground/45 text-sm tracking-[1.6px] uppercase'>
                                    {order.mode ?? 'paylater'}
                                </Text>
                            </View>
                            <View className='flex-row gap-3'>
                                ...
                                <Text className='text-foreground/35 text-sm'>/</Text>
                                <Text className='text-foreground/70 text-sm'>
                            ...
                            <View className='flex-row items-end justify-between'>
                                <View>
                                    <Text className='text-foreground/45 text-xs tracking-[1.8px] uppercase'>
                                        Paid
                                    </Text>
