            ...
            >
                <View style={styles.header}>
                    ...
                    <Text style={styles.headerCopy}>
                        Open the core Fix iT Rock tools from one place: space, orders, transactions,
                        and your linked web workspace.
                    </Text>
                </View>
                ...
                <View style={styles.heroCard}>
                    ...
                    <Text style={styles.heroCopy}>
                        This app is branded for Fix iT Rock and wired to the same data and tools as
