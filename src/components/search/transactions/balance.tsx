...
export function Balance({ balance }: { balance: { get: number; give: number } }) {
    return (
        <div className='flex items-center gap-2'>
            <div className='flex w-full flex-col items-center rounded-xl bg-emerald-50/50 p-2 md:p-4 dark:bg-emerald-500/20'>
            ...
            <div className='flex w-full flex-col items-center rounded-xl bg-red-50/50 p-2 md:p-4 dark:bg-red-500/20'>
